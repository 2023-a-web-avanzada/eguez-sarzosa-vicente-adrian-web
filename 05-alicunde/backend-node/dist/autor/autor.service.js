...
let AutorService = exports.AutorService = class AutorService {
    constructor(datasource) {
        this.datasource = datasource;
        this.usuarioRepository = this.datasource.getRepository(autor_entity_1.AutorEntity);
    }
    find(opciones) {
    ...
    update(datosActualizar, id) {
        return this.usuarioRepository.save({ ...datosActualizar, id });
    }
    delete(id) {
