...
let AutorModule = exports.AutorModule = class AutorModule {
};
exports.AutorModule = AutorModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([autor_entity_1.AutorEntity], 'default'),
        ],
        controllers: [autor_controller_1.AutorController],
        providers: [autor_service_1.AutorService],
        exports: [autor_service_1.AutorService]
    })
], AutorModule);
