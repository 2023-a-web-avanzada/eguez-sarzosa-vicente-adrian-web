...
let LibroModule = exports.LibroModule = class LibroModule {
};
exports.LibroModule = LibroModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([libro_entity_1.LibroEntity], 'default'),
        ],
        controllers: [libro_controller_1.LibroController],
        providers: [libro_service_1.LibroService],
        exports: [libro_service_1.LibroService]
    })
], LibroModule);
